...
export default function SignUp() {
  ...
  const validatePassword = (password: string) => {
    setPasswordRequirements({
      ...
      hasLower: regex.lowerCase.test(password),
      hasUpper: regex.upperCase.test(password),
      hasSpecial: regex.specialCharacter.test(password),
    });
  };
  ...
  return (
    <div className="flex w-[100vw] h-[100vh] justify-center items-center">
      ...
      />
      <div className="flex flex-col w-[30vw] h-[80vh] bg-white justify-center items-center">
        <form
